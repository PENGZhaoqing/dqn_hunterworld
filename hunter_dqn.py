...
from examples.dqn_hunter.base import Base
from examples.dqn_hunter.hunter_game import HunterGame
from examples.dqn_hunter.operators import *
from examples.dqn_hunter.utils import *
...
def main():
    ...
    game = HunterGame(replay_start_size=replay_start_size,
