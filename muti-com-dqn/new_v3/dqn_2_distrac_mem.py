            ...
            while not env.game_over():
                if replay_memory1.size >= history_length and replay_memory1.size > replay_start_size:
                    ...
                    if do_exploration:
                        ...
                        state1 = nd.array(current_state1.reshape(1, 74), ctx=q_ctx)
                        state2 = nd.array(current_state2.reshape(1, 74), ctx=q_ctx)
                ...
                if total_steps % update_interval == 0 and replay_memory1.size > replay_start_size:
                    ...
                    state_batch1 = nd.array(state_batch1.reshape(32, 74), ctx=q_ctx)
                    state_batch2 = nd.array(state_batch2.reshape(32, 74), ctx=q_ctx)

                    nextstate_batch1 = nd.array(nextstate_batch1.reshape(32, 74), ctx=q_ctx)
                    nextstate_batch2 = nd.array(nextstate_batch2.reshape(32, 74), ctx=q_ctx)
