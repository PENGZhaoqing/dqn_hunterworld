...
def createQNetwork_Custom(actions_num, q_ctx, bef_args=None, isTrain=True, batch_size=32):
    if isTrain:
        modQ = mx.module.Module(symbol=sym(actions_num), data_names=('data', 'dqn_action', "dqn_target"),
                                label_names=None,
                                context=q_ctx)
        bind(modQ,
        ...
        modQ = mx.module.Module(symbol=sym(actions_num, predict=True), data_names=('data',), label_names=None,
                                context=q_ctx)
